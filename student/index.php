...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center">STUDENT LOGIN HERE</div>
            <div class="card-body">
                <form method="post" name="login_sform">
                    <div class="form-group">
                        <input class="form-control form-control-lg" id="employee_idno" alt="employee_idno" type="text" placeholder="Student ID" autocomplete="off">
                    </div>
                    <div class="form-group">
                ...
                $('form[name="login_sform"]').on('submit', function(e){
                   ...
                   // var s_status = 1;
                    ...
                    if (employee_idno === '' && p_password ===''){
                        $('#alert-msg').html('<div class="alert alert-danger"> Required Student ID and Password!</div>');
                    }else{
                        $.ajax({
                            type: 'POST',
