              ...
              <div class = "form-group">
               ...
               <div class = "form-group">
                ...
                <select class = "form-control" id = "department" />
                  <option value=""> &larr; Select Courses Option &rarr;</option>
                  <?php 
      ...
      <script>
          document.addEventListener('DOMContentLoaded', () => {
              ...
              btn.addEventListener('click', () => {
                  ...
                  const section = document.querySelector('input[alt=section]').value;
                  const course = $('#department option:selected').val();
