                ...
                <?php foreach ($dep as $row) { ?>
                  <tr>
                    ...
                    <td class="align-right">
                        <i class="fa fa-edit edit_D" style="color: blue" data-toggle="modal" data-target="#edit-department" data-id="<?= htmlentities($row['department_id']); ?>"></i> |
                         <i class="fa fa-trash-alt delete_D" style="color: red" data-toggle="modal" data-target="#delete-department" data-del="<?= htmlentities($row['department_id']); ?>"></i>
                    </td>
                  </tr>
               <?php }?>
                </table>
