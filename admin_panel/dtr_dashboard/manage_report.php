...
<!--               <div class="card-header">
              ...
              <div class = "form-inline" style="margin-left: 10px">
                <label>Date:</label>
                <input type="text" id="myInput" Placeholder="Search..." class="round">

                <button type = "button" id = "reset" class = "btn btn-warning btn_refresh"><i class="fa fa-sync"></i></button>
                 <button onclick="window.print()" class="btn_print btn btn-success"><i class="fa-solid fa-print"></i>Print</button>
