       ...
       <div class="modal-body">
        ...
        <form method = "POST" autocomplete="off">
              ...
              <div class = "form-group">
                  ...
                  <input type = "text"  id = "employee_idno" alt="employee_idno" value="<?php echo $newNum; ?>"  class = "form-control" >
                </div>
                  <div class = "form-group">
               ...
               <div class = "form-group">
                ...
                <div class = "form-group">
                  <label>Schoo Year </label>
                  <input type = "text" id="designation" alt="designation"  class = "form-control" value="2023-2024" disabled/>
                  <input type = "text" id="department" alt="designation"  class = "form-control" value="2023-2024" hidden/>
                </div>

                <div class = "form-group">
                  <label> Course: </label>
                <select class = "form-control" id = "department">
                  <option value="">&larr; Select Course Option &rarr;</option>
