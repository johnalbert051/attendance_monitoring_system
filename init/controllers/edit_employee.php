<?php
  require_once "../model/class_model.php";
	...
	if(ISSET($_POST)){
		...
		$edit = $conn->edit_employee($employee_idno,  $first_name, $middle_name, $last_name, $bdate, $caddress, $cnumber,  $gender, $civilstatus, $datehire, $school_year, $department, $employee_id);
		if($edit == TRUE){
